...
public class Ahu implements Serializable{
    ...
    public int getBleedFilterQty() {
        return bleedFilterQty;
    }

    public void setBleedFilterQty(int bleedFilterQty) {
    ...
    public int getFreshFilterQty() {
        return freshFilterQty;
    }

    public void setFreshFilterQty(int freshFilterQty) {
