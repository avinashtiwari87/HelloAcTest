...
public class TestDetails {
    ...
    private int test_detail_id;
    private String testName;
    private String customer;
    private String rawDataNo;
    ...
    private String calibratedDueOn;
    ...
    public String getRawDataNo() {
        return rawDataNo;
    }

    public void setRawDataNo(String rawDataNo) {
        this.rawDataNo = rawDataNo;
    }
    ...
    public String getCalibratedDueOn() {
        return calibratedDueOn;
    }

    public void setCalibratedDueOn(String calibratedDueOn) {
        this.calibratedDueOn = calibratedDueOn;
    }
    ...
    public String getFilterTypeEficiancy() {
        return filterTypeEficiancy;
    }

    public void setFilterTypeEficiancy(String filterTypeEficiancy) {
        this.filterTypeEficiancy = filterTypeEficiancy;
    }
